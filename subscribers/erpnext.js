...
var ErpnextSubscriber = /*#__PURE__*/_createClass(function ErpnextSubscriber(_ref) {
  var _this = this;
  var updateStrapiService = _ref.updateStrapiService,
    productVariantService = _ref.productVariantService,
    productService = _ref.productService,
    eventBusService = _ref.eventBusService,
    updateErpnextService = _ref.updateErpnextService;
  _classCallCheck(this, ErpnextSubscriber);
  ...
  this.eventBus.subscribe("region.created", /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            console.log("region.created", data);
            _this.updateErpnextService.createRegionInErpnext(data);
          case 2:
          case "end":
  ...
  this.eventBus.subscribe("region.updated", /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _this.updateErpnextService.updateRegionInErpnext(data);
          case 2:
          case "end":
  ...
  this.eventBus.subscribe("product-variant.created", /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _this.updateErpnextService.createProductVariantInErpnext(data);
          case 2:
          case "end":
  ...
  this.eventBus.subscribe("product-variant.updated", /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _this.updateErpnextService.updateProductVariantInErpnext(data);
          case 2:
          case "end":
  ...
  this.eventBus.subscribe("product.updated", /*#__PURE__*/function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(data) {
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            console.log("product.updated", data);
            _this.updateErpnextService.updateProductInErpnext(data);
          case 2:
          case "end":
  ...
  this.eventBus.subscribe("product.created", /*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(data) {
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            console.log(data);
            _this.updateErpnextService.createProductInErpnext(data);
          case 2:
          case "end":
  ...
  this.eventBus.subscribe("product.deleted", /*#__PURE__*/function () {
    var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(data) {
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          case 0:
            console.log("product.deleted", data);
            _this.updateErpnextService.deleteProductInErpnext(data);
          case 2:
          case "end":
  ...
  this.eventBus.subscribe("product-variant.deleted", /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          case 0:
            ...
            _this.updateErpnextService.deleteProductVariantInErpnext(data);
          case 2:
          case "end":
  ...
  this.eventBus.subscribe("region.deleted", /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee9$(_context9) {
        while (1) switch (_context9.prev = _context9.next) {
          case 0:
            ...
            _this.updateErpnextService.deleteRegionInErpnext(data);
          case 2:
          case "end":
...
exports["default"] = ErpnextSubscriber;